    ...
    {:component-did-mount
     ...
     (fn []
      [:div#feature-wrap.align-center
       ...
       [:map {:name "image-map"}
        [:area {:shape "poly"
                :href "https://www.youtube.com/watch?v=CruOht7_Y78&list=PL1wrmPXwKWpZqXnhCjkhJnOpA1mxWrKKY"
                :target "_blank"
        ...
        [:area {:shape "poly"
                ...
                :onMouseOut #(reset! image-state og-img)}]
        [:area {:shape "poly"
                :href "https://sealedrecords.bandcamp.com/album/03"
                :target "_blank"
                ...
                :onMouseOut #(reset! image-state og-img)}]
        [:area {:shape "poly"
                :href "https://www.liviacharman.info/"
                :target "_blank"
